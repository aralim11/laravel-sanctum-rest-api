...
class BlogSeeder extends Seeder
{
    ...
    {
        Blog::insert([
            ['user_id' => '1', 'category_id' => '1', 'title' => 'Tamim\’s revival or Miraz controversy?', 'details' => 'The Chattogram-leg began in the best possible way as Tamim cancelled out Lendl Simmons\' hundred with a magnificent unbeaten 111, the left-hander\'s second BPL ton, to help Minister Group Dhaka register a comprehensive nine-wicket win against Sylhet Sunrisers on the opening day\'s second match.', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
